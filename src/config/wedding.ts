...
export const weddingConfig = {
  ...
  wedding: {
    ...
    story: {
      ...
      intro:
        "This is not only the story of a wedding day. It is the story of Kavya and Tejas arriving at one auspicious moment with the people, rituals and memories that make it meaningful.",
      culturalNote:
        "In a Telugu wedding, celebration and tradition live side by side — pasupu in the morning, a gathering in the evening, and the sacred Muhurtham at the heart of the night.",
    },
    ...
    events: [
      {
        ...
        venue: "Ishaar Staycation, Vijayawada",
        story:
          "The day begins with pasupu, warmth and the easy joy of being surrounded by family.",
...

      {
        ...
        venue: "Ishaar Staycation, Vijayawada",
        story:
          "As evening arrives, loved ones gather to celebrate Kavya and Tejas and welcome the chapter ahead.",
...

      {
        ...
        venue: "Ishaar Staycation, Vijayawada",
        story:
          "At 11:41 PM, celebration becomes ceremony — the auspicious moment that gives their wedding its beginning.",
        plates: ["/images/ceremonies/muhurtam.png"],
      },
    ],

    address:
      "Ishaar Staycation, Chirravuru, Andhra Pradesh 522303, India",

    mapsUrl:
      "https://www.google.com/maps/search/?api=1&query=Ishaar&query_place_id=ChIJt3N6MQD7NToRT_eM6gPrnMk",
  },

  contact: {
    whatsapp: "919848045623",
  },
