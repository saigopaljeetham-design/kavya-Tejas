  ...
  return (
    <section className={`mandap-section mandap-premium ${lit ? "is-lit" : ""}`}>
      ...
      <div className="mandap-reference-frame" aria-label="Wedding mandap">
        ...
        <div className="mandap-caption"><span>K <i>&amp;</i> T</span><b>THE SACRED MANDAPAM</b></div>
      </div>
      ...
      <style jsx global>{`
        ...
        @media(max-width:760px){.mandap-premium{min-height:auto;padding:105px 18px 125px;grid-template-columns:1fr;gap:45px}.mandap-copy{text-align:center;max-width:560px;margin:auto}.mandap-copy h2{font-size:clamp(3rem,14vw,5rem)}.mandap-copy>p:not(.lux-micro){margin-left:auto;margin-right:auto}.mandap-copy button{margin-top:20px}.mandap-reference-frame{justify-self:center;width:min(94vw,520px)}.mandap-reference-image{aspect-ratio:1/1.25}.mandap-caption{left:18px;right:18px;bottom:18px}.mandap-caption b{font-size:.34rem}}
