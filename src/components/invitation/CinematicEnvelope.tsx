...
export function CinematicEnvelope({ onOpen }: { onOpen: () => void }) {
  ...
  return (
    <section className={`cinema-v2 ${opening ? "is-opening" : ""}`} aria-label="Kavya and Tejas wedding invitation">
      <div className="v2-stars" /><div className="v2-bokeh" /><div className="v2-glow" /><div className="v2-frame" />
      <header className="v2-header"><span className="v2-mini-mark">K <i>&amp;</i> T</span><span className="v2-private">A PRIVATE INVITATION</span><span className="v2-controls">EN&nbsp;&nbsp; ♫</span></header>

      <main className="v2-stage">
        <div className="v2-copy">
          <p className="v2-kicker">WITH THE BLESSINGS OF OUR FAMILIES</p>
          <div className="v2-monogram"><span className="v2-ornament top">❧</span><div className="v2-monogram-ring"><strong>K</strong><b>&amp;</b><strong>T</strong></div><span className="v2-ornament bottom">❧</span></div>
          <h1>Kavya <em>and</em> Tejas</h1><div className="v2-rule"><span>✦</span></div>
        ...
        <button className="v2-envelope-wrap" onClick={open} aria-label="Open invitation">
          <div className="v2-envelope">
            <div className="v2-envelope-back" /><div className="v2-inner-card"><small>WITH THE BLESSINGS OF OUR FAMILIES</small><strong>Kavya <i>and</i> Tejas</strong><span>THE BEGINNING OF THEIR FOREVER</span><b>27 · 08 · 2026</b></div>
            <div className="v2-gold-flap" /><div className="v2-front"><span>K <i>&amp;</i> T</span><small>27 · 08 · 2026</small></div>
            <div className="v2-seal"><span>K</span><i>&amp;</i><span>T</span><b>❧</b></div>
          </div>
        </button>
        <button className="v2-open" onClick={open} disabled={opening}><span>{opening ? "OPENING" : "OPEN INVITATION"}</span><b>↓</b></button>
      ...
      <style jsx>{`
        ...
        .v2-glow{position:absolute;width:78vmin;height:78vmin;border-radius:50%;background:radial-gradient(circle,rgba(220,169,65,.14),transparent 68%);filter:blur(35px);animation:v2Glow 7s ease-in-out infinite}.v2-frame{position:absolute;inset:15px;border:1px solid rgba(215,169,77,.28);pointer-events:none}.v2-frame:after{content:"";position:absolute;inset:7px;border:1px solid rgba(215,169,77,.07)}
